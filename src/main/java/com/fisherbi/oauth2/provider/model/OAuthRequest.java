...
import com.fisherbi.oauth2.provider.exception.OAuthException;
import httpclient.multipart.FileByteArrayBodyPartPayload;
import httpclient.multipart.MultipartPayload;
